...
const swaggerDefinition = {
    ...
    info: {
        ...
        version: "1.0.0",
        description:
            "Comprehensive reference for the Modern API service, including middleware behavior, status codes, and data contracts.",
        contact: {
            name: "Modern API",
        },
    },
    ...
    paths: {
        ...
        "/api/auth/login": {
            post: {
                ...
                description:
                    "Authenticates a user and issues the JWT cookie. Protected by `authRateLimiter` (10 requests / 15 minutes).",
                requestBody: {
                    required: true,
                    content: {
                        "application/json": {
        ...
        "/api/auth/register": {
            post: {
                ...
                description:
                    "Creates a user account. Runs through `authRateLimiter` and `checkRegistrationAllowed` (admin bypass via ADMIN_EMAIL/ADMIN_PASSWORD).",
                requestBody: {
                    required: true,
                    content: {
                        "application/json": {
        ...
        "/api/categories/create": {
            post: {
                ...
                description:
                    "Creates a category after normalizing the name. Rate limited by `globalRateLimiter` (100 requests / 15 minutes).",
                requestBody: {
                    required: true,
                    content: {
                        "application/json": {
        ...
        "/api/articles/articles": {
            post: {
                ...
                description:
                    "Creates an article with optional images. Requires an authenticated admin, is throttled by `doubleClickLimiter` (1 request / 5 seconds), and leverages the Cloudinary upload middleware.",
                security: [{ cookieAuth: [] }],
                requestBody: {
                    required: true,
                    content: {
